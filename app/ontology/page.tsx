          ...
          <>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                <div>
                  <h2 style={{ fontSize: '1.25rem', marginBottom: '0.35rem', fontWeight: 600 }}>Belief dump → trusted rules</h2>
                  <p style={{ color: 'rgba(255,255,255,0.48)', fontSize: '0.84rem', margin: 0, lineHeight: 1.45 }}>
                ...
                <div style={{ display: 'flex', gap: '0.45rem', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
                  ...
                  <StagePill label={`${axioms.filter((axiom) => axiom.status === 'confirmed' && axiom.scope === 'personal').length} trusted`} tone="trusted" />
                </div>
              </div>
...
I work better when I can correct a draft instead of starting from blank.`}
              ...
              <div style={{ marginTop: '0.9rem', display: 'flex', gap: '0.65rem', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                {beliefRuleMessage && (
                  <span style={{ color: 'rgba(255,255,255,0.48)', fontSize: '0.78rem', lineHeight: 1.4 }}>
                    {beliefRuleMessage}
                  </span>
                )}
                {beliefRuleError && (
